...
export default () => {
  return (
    <Theme theme={theme}>
      <GlobalPageStyles pageUrl={"aboutus"} />
      ...
      <Section color="--light" font="--base">
        <BgImageParallax
          ...
          margin="0px 0 0px 0"
          sm-padding="40px 0"
          imageURL="/DiomedialCNet/etc/team.webp"
      ...
      <Section padding="80px 0 80px 0">
        ...
        >
          <Box position="relative" display="flex" flex-direction="column">
            ...
            >
              <Image
                src="/DiomedialCNet/avatars/danila.webp"
                border-radius="16px"
                width="100%"
                object-fit="cover"
                position="absolute"
            ...
            <Box padding="0px 20px 0px 20px" margin="0px 0px 16px 0px">
              ...
              <Text
                ...
                color="--darkL2"
              >
                Я смею всё, что можно человеку, кто смеет больше, тот не
                человек!
              </Text>
            </Box>
            <SocialMedia
              ...
              github="https://github.com/soul-on-you"
            >
              <Override
                slot="link"
                border-radius="50%"
          ...
          <Box position="relative" display="flex" flex-direction="column">
            ...
            >
              <Image
                src="/DiomedialCNet/avatars/fedor.webp"
                border-radius="16px"
                width="100%"
                object-fit="cover"
                position="absolute"
            ...
            <Box padding="0px 20px 0px 20px" margin="0px 0px 16px 0px">
              ...
              <Text
                ...
                color="--darkL2"
              >
                Любые разумные существа должны помнить: путь без развития ведёт
                к деградации, а деградация ведёт к вымиранию.
                <br />
              </Text>
            </Box>
            <SocialMedia
              margin="12px 0px 24px 0px"
              github="https://github.com/VainglorPrime"
              vkontakte="https://vk.com/vainglor_prime"
            >
              <Override
                slot="link"
                border-radius="50%"
          ...
          <Box position="relative" display="flex" flex-direction="column">
            ...
            >
              <Image
                src="/DiomedialCNet/avatars/kirill.webp"
                border-radius="16px"
                width="100%"
                object-fit="cover"
                position="absolute"
            ...
            <Box padding="0px 20px 0px 20px" margin="0px 0px 16px 0px">
              ...
              <Text
                ...
                color="--darkL2"
              >
                Важная составляющая любого начинания - не потерять к нему
                интереса
              </Text>
            </Box>
            <SocialMedia
              margin="12px 0px 24px 0px"
              vkontakte="https://vk.com/lovchui "
              telegram="https://t.me/limon1488"
            >
              <Override
                slot="link"
                border-radius="50%"
