...
import { StackItem, Stack, RawHtml, Override } from "@quarkly/components";
...
export default () => {
  return (
    <Theme theme={theme}>
      <GlobalPageStyles pageUrl={"pricing"} />
      ...
      >
        <BgImageParallax
          ...
          margin="0px 0 0px 0"
          sm-padding="40px 0"
          imageURL="/DiomedialCNet/etc/parallaxv2.webp"
      ...
      <Section padding="80px 0 80px 0">
        ...
        >
          ...
          >
            <Image
              src="/DiomedialCNet/etc/offer1.webp"
              border-radius="16px"
          ...
          >
            ...
            <Image
              src="/DiomedialCNet/etc/offer2.webp"
              border-radius="16px"
              margin="0px 0px 32px 0px"
              max-width="100%"
              md-width="100%"
